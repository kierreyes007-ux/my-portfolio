      ...
      <div className="Featured-Products grid py-5 grid">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 justify-items-center py-4 gap-10 px-5">
                  {product.slice(0,8)?.map((prod) => (
                    <div key={prod.id}className="card grid rounded-xl bg-white relative px-3 py-4 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl justify-items-center">
